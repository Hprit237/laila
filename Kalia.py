...
TOKEN = '7777560817:AAEMzfds1KBz1mG6hWVBkd8J8MjxyWb7xyM'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [1969801413]
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        ...
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @KaliaYtOwner\n"
...
def show_id(message):
    ...
    bot_owner = "KaliaYtOwner"  # 👑 The bot owner's username  ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @KaliaYtOwner")
...
This bot is owned and operated by @KaliaYtOwner on Telegram and KaliaYtOwner on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:
...
* **🚫 LIMITATION OF LIABILITY**: The owner and operator of this bot, @KaliaYtOwner on Telegram and KaliaYtOwner on Instagram, shall not be liable for any damages or losses arising from the use of this bot, including but not limited to direct, indirect, incidental, punitive, and consequential damages, including loss of profits, data, or business interruption.
...
* **🤝 INDEMNIFICATION**: You agree to indemnify and hold harmless @KaliaYtOwner on Telegram and KaliaYtOwner on Instagram, and its affiliates, officers, agents, and employees, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from or related to your use of this bot.
* **🌐 THIRD-PARTY LINKS**: This bot may contain links to third-party websites or services, and you acknowledge that @KaliaYtOwner on Telegram and KaliaYtOwner on Instagram is not responsible for the content, accuracy, or opinions expressed on such websites or services.
* **🔄 MODIFICATION AND DISCONTINUATION**: You agree that @KaliaYtOwner on Telegram and KaliaYtOwner on Instagram may modify or discontinue this bot at any time, without notice, and that you will not be entitled to any compensation or reimbursement for any losses or damages arising from such modification or discontinuation.
...
* **📝 ENTIRE AGREEMENT**: This disclaimer constitutes the entire agreement between you and @KaliaYtOwner on Telegram and KaliaYtOwner on Instagram regarding your use of this bot, and supersedes all prior or contemporaneous agreements or understandings.
